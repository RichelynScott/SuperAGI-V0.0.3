...
#ORIGINAL COMMITTED OUT TO INCLUDE NEW CODE THAT ALLOWS TOOLS TO RUN IF ALIAS IS CALLED
...
TOOL_ALIASES = {
    "Write File": ["write file", "WriteFile", "writefile", "Write_File", "write_file"],
    "List Files": ["list files", "ListFiles", "listfiles", "List_Files", "list_files"],
    "Append File": ["append file", "AppendFile", "appendfile", "Append_File", "append_file"],
    "Read File": ["read file", "ReadFile", "readfile", "Read_File", "read_file"],
    # Add more tools and their aliases here
}

def add_or_update_tool(db: Session, tool_name: str, folder_name: str, class_name: str, file_name: str):
    # Find the correct tool name if the provided tool_name is an alias
    for true_name, aliases in TOOL_ALIASES.items():
